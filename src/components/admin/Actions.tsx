...
function Actions({viewNav,editNav,_id,is_blocked,setSelectedData,setIsConfirmationModalOpen}:ActionProps) {
  ...
  return (
    <div className="flex">
      ...
      <button className={`${is_blocked ? "neumorphic-clicked bg-red-950" : "neumorphic-navBtn"}  py-2 px-2 ml-1 w-8 h-8 rounded-lg`} onClick={() =>{setSelectedData && setSelectedData({is_blocked:!is_blocked,_id}),setIsConfirmationModalOpen(true)}}>
