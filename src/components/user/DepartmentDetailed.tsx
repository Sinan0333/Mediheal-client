...
function DepartmentDetailed({data}:DepartmentDetailedProps) {
  ...
  <div className="h-96 lg:h-auto lg:w-48 flex-none bg-cover rounded-t lg:rounded-t-none lg:rounded-l text-center overflow-hidden" style={{backgroundImage: `url(${imageUrl})`}}title="Woman holding a mug">
  </div>
