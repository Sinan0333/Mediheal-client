...
function ExistingPatientCard({data}:ExistingPatientCardProps) {

    const imageUrl = `https://res.cloudinary.com/dw2cscitl/${data.image}`;

  return (
    <div className="flex flex-col mb-6 mr-4  items-center bg-white border border-gray-200 rounded-lg shadow md:flex-row md:max-w-xl hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
